<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TicketDumpReports.aspx.cs" Inherits="Reports" %>
            ...
            <td>
                <table id="Table1" runat="server" cellpadding="4" cellspacing="0">
                    <tr>
                        ...
                        <td>
                           <telerik:RadComboBox ID="cmbReport" MaxHeight="320px" runat="server" Width="300px"
                                AutoPostBack="true" Skin="Office2007" Filter="Contains">
                               <Items>
                                   <telerik:RadComboBoxItem Text="" Value="" />
                                     <telerik:RadComboBoxItem Text="Ticket Dump Report" Value="1" />
                                     <telerik:RadComboBoxItem Text="Wallet Dump Report" Value="2" />
                               </Items>
