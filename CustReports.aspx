<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustReports.aspx.cs" Inherits="Invoice" %>
...
<body>
    ...
    <table width="100%" id="tbl_Search" style="display: block;">
        <tr class="tdMainHeader1">
            <th id="thCustomerHeader" runat="server" class="tdSubHeader" width="100%">Invoice
            </th>
        </tr>
        <tr>
            <td>
            ...
            <telerik:RadTreeView runat="Server" ID="RadTreeView1" 
                    ...
                    <Nodes>                       
                           ...
                           <telerik:RadTreeNode runat="server" Text="Invoice Summary Report" Expanded="true" PostBack="false">
                            <Nodes>
                                  <telerik:RadTreeNode runat="server" Text="Ticket Summary" Value="CAS-AccountCount">
                                </telerik:RadTreeNode> 
